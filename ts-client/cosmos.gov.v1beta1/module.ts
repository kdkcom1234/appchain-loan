...
export { TallyResult, QueryProposalRequest, QueryProposalsRequest, MsgDeposit, Proposal, TallyParams, QueryParamsResponse, MsgVoteWeighted, QueryProposalResponse, QueryVoteRequest, QueryDepositsRequest, QueryProposalsResponse, QueryParamsRequest, QueryDepositResponse, QueryDepositsResponse, MsgVote, MsgDepositResponse, WeightedVoteOption, QueryVoteResponse, QueryVotesRequest, MsgSubmitProposal, MsgVoteWeightedResponse, TextProposal, VotingParams, GenesisState, QueryVotesResponse, QueryTallyResultResponse, MsgVoteResponse, Deposit, DepositParams, QueryTallyResultRequest, Vote, QueryDepositRequest, MsgSubmitProposalResponse };
